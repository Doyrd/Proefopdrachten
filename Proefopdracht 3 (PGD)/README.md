...
|week 2 | Verbreding van spel en extra onderzoek naar software. | Spel afronden en vereiste onderdelen afchecken. | Documentatie afronden en vereiste onderdelen inleveren. | Reflecteren en project pagina op portfolio creeëren en afronden. | Inleveren van de portfolio pagina en het reflectie formulier. |
